...
# Summary: This project executes a series of queries using a Professor provided database.

USE crime_data;

#1. Write a query to extract the number of different crime types are in the incident_reports table. Name the
...
# couldn't get it to return, but I think it's right.
...
SELECT offense_category, COUNT(offense_category)
FROM nibrs_codes
GROUP BY offense_category
HAVING offense_category = "Embezzlement";
# 1 account of embezzlement
